...
const PointsControl = () => {
  ...
  const headers = [
    ...
    { title: "Депы", hoverText: "Депы" },
    { title: "Додепы", hoverText: "Додепы" },
    { title: "Tir1", hoverText: "Tir1" },
    { title: "Tir2", hoverText: "Tir2" },
    { title: "Отчет", hoverText: "Отчет" },
  ];
    ...
    <div className="px-4">
      ...
      <div
        className={`overflow-y-auto bg-[#2F313B] rounded-xl ${
          filteredData.length <= 5 ? "h-auto" : "h-[385px]"
        }`}
      >
              ...
              filteredData.map((member) =>
                member.stats.map((stat) => (
                  <tr key={stat.id}>
                    ...
                    <td className="px-2 py-2 border-l border-b border-gray-500 text-center font-normal text-[15px]">
                      {stat.deposits}
                    </td>
                    <td className="px-2 py-2 border-b border-gray-500 text-center font-normal text-[15px]">
                      {stat.redeposits}
